...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // z-[1100] rather than Tailwind's z-50 - Leaflet's own CSS uses
        // z-index up to 1000 for its controls (leaflet.css), and this
        // overlay/content render via a Radix portal into document.body, so
        // they compete directly with Leaflet's panes/controls in the same
        // global stacking context rather than nesting under RouteMap's DOM.
