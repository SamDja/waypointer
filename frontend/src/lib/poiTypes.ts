...
export const POI_TYPES: PoiTypeConfig[] = [
  ...
  { key: "hospital", label: "Hospital", icon: Hospital, color: colors.rose[700], symHints: ["hospital"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "pharmacy", label: "Pharmacy", icon: Pill, color: colors.rose[700], symHints: ["pharmacy", "drug store", "drugstore"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "bar", label: "Bar", icon: Beer, color: colors.amber[700], symHints: ["bar", "pub"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "bike_shop", label: "Bike Shop", icon: Wrench, color: colors.amber[700], symHints: ["bike shop", "bicycle shop"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "coffee", label: "Coffee", icon: Coffee, color: colors.amber[700], symHints: ["coffee", "cafe"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "food", label: "Food", icon: Utensils, color: colors.amber[700], symHints: ["food", "restaurant", "dining"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "gas_station", label: "Gas Station", icon: Fuel, color: colors.amber[700], symHints: ["gas station", "fuel", "petrol"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "groceries", label: "Groceries", icon: ShoppingBasket, color: colors.amber[700], symHints: ["grocery", "groceries", "supermarket"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "shopping", label: "Shopping", icon: ShoppingBag, color: colors.amber[700], symHints: ["shopping", "shop", "store"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "winery", label: "Winery", icon: Wine, color: colors.amber[700], symHints: ["winery", "vineyard"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  ...
  { key: "bike_share", label: "Bike Share", icon: HeartHandshake, color: colors.cyan[700], symHints: ["bike share", "bike sharing"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "chairlift", label: "Chairlift", icon: CableCar, color: colors.cyan[700], symHints: ["chairlift", "chair lift"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "e_bike_charging", label: "E-Bike Charging", icon: BatteryCharging, color: colors.cyan[700], symHints: ["e-bike", "ebike charging", "charging"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "ferry", label: "Ferry", icon: Ship, color: colors.cyan[700], symHints: ["ferry"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "parking", label: "Parking", icon: ParkingCircle, color: colors.cyan[700], symHints: ["parking"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "transit", label: "Transit", icon: Train, color: colors.cyan[700], symHints: ["transit", "bus stop", "train station", "station"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "campsite", label: "Campsite", icon: Tent, color: colors.green[700], symHints: ["campsite", "camping", "camp ground", "campground"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "dog_park", label: "Dog Park", icon: PawPrint, color: colors.green[700], symHints: ["dog park"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "geocache", label: "Geocache", icon: Gem, color: colors.green[700], symHints: ["geocache"], searchable: false },
  { key: "park", label: "Park", icon: TreePine, color: colors.green[700], symHints: ["park"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "rest_area", label: "Rest Area", icon: RockingChair, color: colors.green[700], symHints: ["rest area", "picnic"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "swimming", label: "Swimming", icon: WavesLadder, color: colors.green[700], symHints: ["swimming", "swim", "pool"], searchable: true, defaultMaxDistanceM: 50, minDistanceM: 1, maxDistanceM: 500 },
  { key: "trailhead", label: "Trailhead", icon: Map, color: colors.green[700], symHints: ["trailhead", "trail head"], searchable: false },
  { key: "summit", label: "Summit", icon: MountainSnow, color: colors.green[700], symHints: ["summit", "peak"], searchable: true, defaultMaxDistanceM: 10, minDistanceM: 1, maxDistanceM: 500 },
  ...
  { key: "atm", label: "ATM", icon: Banknote, color: colors.violet[700], symHints: ["atm", "cash machine", "bank"], searchable: true, defaultMaxDistanceM: 10, minDistanceM: 1, maxDistanceM: 500 },
  { key: "art", label: "Art", icon: Palette, color: colors.teal[600], symHints: ["art", "sculpture"], searchable: true, defaultMaxDistanceM: 10, minDistanceM: 1, maxDistanceM: 500 },
